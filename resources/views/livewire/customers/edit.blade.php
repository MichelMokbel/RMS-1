    ...
    private function rules(): array
    {
        return [
            'customer_code' => array_filter([
                ...
                config('customers.enforce_unique_customer_code') ? Rule::unique('customers', 'customer_code')->ignore($this->customer->id) : null,
            ]),
            ...
            'phone' => array_filter([
                'nullable', 'string', 'max:50',
                config('customers.enforce_unique_phone') ? Rule::unique('customers', 'phone')->ignore($this->customer->id) : null,
            ]),
            'email' => array_filter([
                'nullable', 'email', 'max:255',
                config('customers.enforce_unique_email') ? Rule::unique('customers', 'email')->ignore($this->customer->id) : null,
            ]),
