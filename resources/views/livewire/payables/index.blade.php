                ...
                <div>
                    ...
                    <div
                        ...
                        x-data="{
                            ...
                            options: @js($suppliers->map(fn ($supplier) => ['id' => (int) $supplier->id, 'name' => $supplier->name])->values()),
                            init() {
                            ...
                            choose(item) {
                                ...
                                this.open = false;
                                this.$wire.set('supplier_id', item.id, true);
                            },
                            clearSelection() {
                                this.selectedId = null;
                                this.query = '';
                                this.open = false;
                                this.$wire.set('supplier_id', null, true);
                            },
                        }"
                    ...
                    <div>
                        ...
                        <div
                            ...
                            x-data="{
                                open: false,
                                query: '',
                                selectedId: @js($recurring_supplier_id),
                                options: @js($suppliers->map(fn ($supplier) => ['id' => (int) $supplier->id, 'name' => $supplier->name])->values()),
                                init() {
                                    const selected = this.options.find((item) => Number(item.id) === Number(this.selectedId));
                                    this.query = selected ? selected.name : '';
                                ...
                                choose(item) {
                                    ...
                                    this.query = item.name;
                                    this.open = false;
                                    this.$wire.set('recurring_supplier_id', item.id);
                                },
                                clearSelection() {
                                    this.selectedId = null;
                                    this.query = '';
                                    this.open = false;
                                    this.$wire.set('recurring_supplier_id', null);
                                },
                            }"
                            x-on:keydown.escape.stop="open = false"
                            x-on:click.outside="open = false"
                ...
                <div>
                    ...
                    <div
                        ...
                        x-data="{
                            open: false,
                            query: '',
                            selectedId: @js($payment_supplier_id),
                            options: @js($suppliers->map(fn ($supplier) => ['id' => (int) $supplier->id, 'name' => $supplier->name])->values()),
                            init() {
                                const selected = this.options.find((item) => Number(item.id) === Number(this.selectedId));
                                this.query = selected ? selected.name : '';
                            ...
                            choose(item) {
                                ...
                                this.query = item.name;
                                this.open = false;
                                this.$wire.set('payment_supplier_id', item.id, true);
                            },
                            clearSelection() {
                                this.selectedId = null;
                                this.query = '';
                                this.open = false;
                                this.$wire.set('payment_supplier_id', null, true);
                            },
                        }"
                        x-on:keydown.escape.stop="open = false"
                        x-on:click.outside="open = false"
