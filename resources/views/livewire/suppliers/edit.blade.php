...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function mount(Supplier $supplier): void
    {
        ...
        $this->default_expense_account_id = $supplier->default_expense_account_id;
        $this->preferred_payment_method = $supplier->preferred_payment_method;
        $this->hold_status = $supplier->hold_status ?: 'open';
        $this->requires_1099 = (bool) $supplier->requires_1099;
        $this->approval_threshold = $supplier->approval_threshold !== null ? (float) $supplier->approval_threshold : null;
    }
