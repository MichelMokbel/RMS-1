...
<div class="space-y-6 max-w-2xl">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-lg font-semibold text-neutral-900 dark:text-neutral-100">{{ __('Create Category') }}</h1>
            <p class="text-sm text-neutral-600 dark:text-neutral-300">{{ __('Add a new category.') }}</p>
        </div>
