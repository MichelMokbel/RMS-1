...
<head>
    ...
    <title>All Suppliers Statement</title>
    <style>
...
<body>
    <div class="no-print">
        ...
        <a class="btn" href="{{ route('reports.suppliers-statement') }}">Back to Report</a>
    </div>
    @include('reports.print-header', ['reportTitle' => 'All Suppliers Statement'])
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td class="right">{{ $formatMoney($row['opening']) }}</td>
                    <td class="right">{{ $formatMoney($row['invoices']) }}</td>
                    <td class="right">{{ $formatMoney($row['payments']) }}</td>
                    <td class="right">{{ $formatMoney($row['closing']) }}</td>
                </tr>
            @empty
