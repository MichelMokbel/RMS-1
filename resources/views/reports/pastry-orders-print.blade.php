...
<head>
    ...
    <title>Pastry Orders Report</title>
    <style>
...
<body>
    <div class="toolbar no-print">
        ...
        <a class="btn" href="{{ route('reports.pastry-orders') }}">Back to Report</a>
    </div>
    @include('reports.print-header', ['reportTitle' => 'Pastry Orders Report'])
    <div class="meta">
