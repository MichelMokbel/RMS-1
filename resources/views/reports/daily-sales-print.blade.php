...
<body>
    ...
    @include('reports.print-header', ['reportTitle' => 'Daily Sales Report'])
    <table>
        <thead>
            <tr>
                <th>Date</th>
        ...
        <tfoot>
            <tr>
                ...
                <td class="right"><strong>{{ (int) $days->sum('count') }}</strong></td>
                <td class="right"><strong>{{ $formatCents((int) $days->sum('total_cents')) }}</strong></td>
            </tr>
        </tfoot>
    </table>
