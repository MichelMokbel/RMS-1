    ...
    <table>
        ...
        <tfoot>
            <tr>
                ...
                <td class="right"><strong>{{ $formatCents((int) $rows->sum('opening')) }}</strong></td>
                <td class="right"><strong>{{ $formatCents((int) $rows->sum('invoices')) }}</strong></td>
                <td class="right"><strong>{{ $formatCents((int) $rows->sum('payments')) }}</strong></td>
                <td class="right"><strong>{{ $formatCents((int) $rows->sum('closing')) }}</strong></td>
            </tr>
        </tfoot>
    </table>
