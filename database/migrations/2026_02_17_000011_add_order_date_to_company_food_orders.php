...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasColumn('company_food_orders', 'order_date')) {
        ...
        $indexExists = DB::select("SHOW KEYS FROM company_food_orders WHERE Key_name = 'company_food_orders_project_id_order_date_index'");
