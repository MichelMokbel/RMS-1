...
| Legacy opening | Existing payment and historical allocations plus opening used quantity and current bookings reconcile without reposting history. Repeat backfill is unchanged. Missing payment or conflicting totals cannot create a synthetic receipt or force a customer purchase |
